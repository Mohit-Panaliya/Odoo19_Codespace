...
echo "📦 2. Installing System Dependencies for Odoo 19..."
sudo apt-get update -y
sudo apt-get install -y postgresql postgresql-contrib libldap2-dev libsasl2-dev libpq-dev python3-dev build-essential wkhtmltopdf libjpeg-dev zlib1g-dev libffi-dev
...
echo "📥 5. Cloning Odoo 19 (Master Branch)..."
if [ ! -d "odoo" ]; then
...
echo "✅ Infrastructure for Odoo 19 Ready!"
